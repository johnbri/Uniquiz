...
function Room(props){
    ...
    return started ? NoDataView(data, "Loading room") // om man inte klickat på start så renderas vanliga viewn, annars renderas NoDataView tills .then nedan anropas när combined playlist är klart
